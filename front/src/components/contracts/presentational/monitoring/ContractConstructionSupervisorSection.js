...
const ContractConstructionSupervisorSection = ({
    contact = null,
            ...
            {contact ? (
                ...
                <Stack alignItems="center" spacing={2}>
                    <Typography p={6} sx={{fontStyle: "italic"}}>
                        Este contrato aún no tiene un supervisor constructivo asignado
                    </Typography>
                    <Grid item container xs={12} mt={3} justifyContent="center">
                        <AddContactButtonGroup
                            basePath="supervisor_constructivo"
                            btnName="Asignar supervisor constructivo"
                        />
                    </Grid>
                </Stack>
            )}
...
export default ContractConstructionSupervisorSection;
